 ...
 *
 * A modified version of the default sliding menu overlay animation
 * for the OnsenUI framework. This version uses a darker overlay.
 *
 * OverlaySlidingMenuAnimator:
 * https://github.com/OnsenUI/OnsenUI/blob/master/framework/views/overlaySlidingMenuAnimator.js
 *
  ...
  module.factory('DarkOverlaySlidingMenuAnimator', ['SlidingMenuAnimator', function(SlidingMenuAnimator) {
    ...
    var DarkOverlaySlidingMenuAnimator = SlidingMenuAnimator.extend({
      ...
      _generateMainPageStyle: function(distance) {
        var max = this._menuPage[0].clientWidth;
        var opacity = 1 - (this._opacityModifier * distance / max);
      ...
      copy: function() {
        return new DarkOverlaySlidingMenuAnimator();
      }
    });
